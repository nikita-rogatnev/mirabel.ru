...
namespace logoWidget\logoWidget;
...
class LogoWidgetShortcodes extends Container implements Module
{
    use EventsFilters;
    ...
    public function __construct()
    {
        if (!defined('VCV_LOGO_WIDGET_SHORTCODE')) {
            ...
            $this->addFilter('vcv:editor:variables vcv:editor:variables/logoWidget', 'getVariables');
